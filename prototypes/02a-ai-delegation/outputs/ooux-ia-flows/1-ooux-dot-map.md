# OOUX Dot Map - 02-ai-lead (Calo Tracker)
...
| **Secondary** | Partner Link | Links primary user to partner profile | create, remove, switch |
...
| Attribute | Type | Status |
|-----------|------|--------|
| primary user id | text | Required |
| partner user id | text | Required |
| created at | timestamp | Auto |

*Note: Partner is a User object with its own profile, goals, and food logs. Partner Link connects two User profiles for shared meal logging.*
